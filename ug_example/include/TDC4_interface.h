...
typedef struct {
        ...
        /*! \brief The index in the list of XTDC4 boards that should be
         *initialized.
         *
         *	There might be multiple boards in the system that are handled by
         *this driver as reported by @link initialization ndigo_count_devices()
...
typedef struct {
        ...
        tdc4_trigger trigger[TDC4_TRIGGER_COUNT]; //!< Configuration of external
                                                  //!< trigger sources
        tdc4_tiger_block
            tiger_block[TDC4_TIGER_COUNT]; //!< configuration of the
                                           //!< timing generator
        tdc4_channel
...
typedef struct {
        crono_bool_t
            acknowledge_last_read; //!< xtdc4_read automatically acknowledges
...
typedef struct {
        ...
        /*! \brief error code
         *
         *	The assignments of the error codes can be found @link deferror
         *here
         *@endlink.
         */
        int error_code;
