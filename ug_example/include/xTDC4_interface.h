//
// Header file containing structs and #defines specific for the xTDC4
// The current driver version for xTDC4 devices is 1.4.1
//
...
#define VER_FILE_VERSION 1, 0, 0, 1
 ...
 *first obtain a structure that contains the default settings of the device read
 *from an on board ROM, then modify the structure as needed for the user
 ...
 *	- @link defstatinfo xtdc4_get_static_info() @endlink
 *	- @link defparaminfo xtdc4_get_param_info() @endlink
 *	- @link defslowinfo xtdc4_get_slow_info() @endlink
 *	- @link deffastinfo xtdc4_get_fast_info() @endlink
 ...
 *xtdc4_pause_capture. Return values are listed @link defcontcap here @endlink.
 *	\param *device is type @link xtdc4_device xtdc4_device @endlink
 */
 ...
 *
 *	this is only necessary if read is not called. Return values are listed
 ...
 *obtained within a few microseconds. Return values are listed @link deffastinfo
 *here @endlink. \param *device of type xtdc4_device \param *info of type
 *xtdc4_fast_info
 */
...
/*!	\ingroup initfuncts
 *	\brief Return the number of boards that are supported by this driver in
 *the system. \param *error_code is type int \param **error_message is type
 *const char
 */
 ...
 *error information should be written by the driver. Return values are listed
 *@link definit here @endlink. \param *params type xtdc4_init_parameters \param
 **error_code is type int \param **error_message is type char. The buffer for
 *the error message has to contain at least 80 chars.
 */
